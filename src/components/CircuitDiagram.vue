...
<template>
  <svg
    class="w-full max-w-[520px] h-auto [&_.wires]:stroke-gray-100 [&_.wires]:stroke-2 [&_.wires]:fill-none [&_.source_line]:stroke-gray-100 [&_.source_line]:stroke-2 [&_.source_line]:fill-none [&_.source-circle]:stroke-gray-100 [&_.source-circle]:stroke-2 [&_.source-circle]:fill-none [&_.resistor-path]:stroke-gray-100 [&_.resistor-path]:stroke-2 [&_.resistor-path]:fill-none [&_.resistor-path]:stroke-linejoin-round [&_.resistor-path]:stroke-linecap-round [&_text]:font-sans [&_.resistor-label]:text-[11px] md:text-xs [&_.resistor-label]:font-bold [&_.resistor-label]:fill-amber-600 [&_.source-plus]:stroke-gray-100 [&_.source-plus]:stroke-2 [&_.source-minus]:stroke-gray-100 [&_.source-minus]:stroke-2 [&_.source-label]:text-[11px] md:text-xs [&_.source-label]:font-bold [&_.source-label]:fill-blue-400 [&_.point-dot]:fill-red-500 [&_.point-dot]:stroke-gray-900 [&_.point-dot]:stroke-[1.5] [&_.point-label]:text-[13px] md:text-sm [&_.point-label]:font-bold [&_.point-label]:fill-gray-100"
